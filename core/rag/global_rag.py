"""
Minimal Global RAG Service: indexes local knowledge files and provides search.

Uses sentence-transformers if available; falls back to simple keyword scoring.
"""
...
class GlobalRAG:
    def __init__(self, knowledge_dir: str = "knowledge", model_name: Optional[str] = None):
